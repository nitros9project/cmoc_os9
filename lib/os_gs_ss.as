...
_os_gs_size         EXPORT              ; export modern size wrapper
_os_gs_pos          EXPORT              ; export modern position wrapper
_os_gs_ready        EXPORT              ; export modern ready wrapper
_os_gs_eof          EXPORT              ; export modern eof wrapper
_os_gs_popt         EXPORT              ; export modern path-options getter
_os_gs_devnm        EXPORT              ; export modern device-name getter
_os_gs_fd           EXPORT              ; export modern file-descriptor getter
_os_ss_popt         EXPORT              ; export modern path-options setter
_os_ss_pfd          EXPORT              ; export modern file-descriptor setter
_os_ss_sendsig      EXPORT              ; export modern send-signal setter
_os_ss_ticks        EXPORT              ; export modern ticks setter
_os_ss_reset        EXPORT              ; export modern reset setter
_os_ss_relea        EXPORT              ; export modern release setter
