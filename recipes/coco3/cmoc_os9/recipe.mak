...
CMOC_OS9_TESTS = hello noop timetest fiotest iotest osiotest osopenerrtest syscalltest memtest forktest forkhellotest forknowaittest forknooptest printtest osgstattest utimetest ctypetest string floattest floatfmttest getopttest popentest pwenttest defdrivetest pwcryptest errmsgtest stdlibtest stdioedgetest streamiotest searchtest stringexttest randtest filelayout setjmptest systemtest setstest dirtest compat3test signaltest intercepttest dirapitest misctest datmodstest attrwraptest abortchild aborttest
