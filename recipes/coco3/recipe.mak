...
CMOC_OS9_GRAPHICS_TESTS = wintest maze text40 text40edit gfx80 gfx80draw gfx40draw gfx40win gfx40buf
CMOC_OS9_UTILITIES = wc cat head cmp tr cut echo sleep tee rev strings cksum uniq comm split paste seq basename dirname true false yes tail sync tty mkdir rmdir cal fold nl expand unexpand od sort touch uuencode uudecode
