...
char    os9obuf[OBUFSIZE];             /* terminal output buffer */
int     os9nobuf;                      /* # of bytes in above */
#endif
...
#endif
#ifdef OS9
        _os_gs_popt(0, &ostate);       /* save old state */
        _os_gs_popt(0, &nstate);       /* get base of new state */
